const OpcodeLookupTable: []const []const u8 = &.{
    ...
    "RET NC",     "POP DE",    "JP NC,a16",  "INV",       "CALL NC,a16", "PUSH DE",   "SUB d8",     "RST 10H",   "RET C",       "RETI",      "JP C,a16",   "INV",       "CALL C,a16", "INV",      "SBC A,d8",   "RST 18H",
    "LDH (a8),A", "POP HL",    "LD (C),A",   "INV",       "INV",         "PUSH HL",   "AND d8",     "RST 20H",   "ADD SP,r8",   "JP (HL)",   "LD (a16),A", "INV",       "INV",        "INV",      "XOR d8",     "RST 28H",
